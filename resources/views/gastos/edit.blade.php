...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Editar Gasto'])
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fecha" name="fecha" value="{{ old('fecha', $gasto->fecha->format('Y-m-d')) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="concepto_id" name="concepto_id" required>
                                            ...
                                            @foreach($conceptos as $concepto)
                                                <option value="{{ $concepto->id }}" {{ $gasto->concepto_id == $concepto->id ? 'selected' : '' }}>
                                                    {{ $concepto->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="valor" name="valor" value="{{ old('valor', $gasto->valor) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="detalles" class="form-control-label">Detalles</label>
                                <textarea class="form-control" id="detalles" name="detalles" rows="3">{{ old('detalles', $gasto->detalles) }}</textarea>
                            </div>
